          ...
          <ul>
            <li>
              ...
              <p className="pb-7">
                ...
                is a handmade classic of comfort and craft. Gracefully sculpted.
                A one-piece base construction for strength. Woven skillfully
                back and front of durable paper yarn, the Paddle Chair is
                remarkably comfortable. An investment that will gain value over
                time.
              </p>
              <div className="flex">
